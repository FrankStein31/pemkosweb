...
foreach($tenagadidik->result() as $data){
};
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php echo $this->session->flashdata('suces')?>
                    ...
                    <form role="form" method="POST" action="<?php echo site_url('admin/tenagadidik/prosesedit')?>" enctype='multipart/form-data'>
                    <div class="modal-body">
                        <input type="hidden" name="id" value="<?= $data->id_tenaga_didik;?>"/>
                        ...
                        <input class="form-control" placeholder="Nomor Induk Pegawai" value="<?= $data->nip;?>" name="nip" required><br>
                        <span>Jabatan</span>
                        <input class="form-control" placeholder="Jabatan" value="<?= $data->jabatan;?>" name="jabatan" required><br>
                        ...
                        <span>Alamat</span>
                        <textarea class="form-control" name="alamat" rows="4" cols="50"  placeholder="Alamat lengkap" ><?= $data->alamat_tenaga_didik;?></textarea>
                        <br>


                        <span>Keterangan Spesialis</span>
                        <textarea class="form-control" name="keterangan" rows="4" cols="50"  placeholder="Keterangan Spesialis" ><?= $data->keterangan;?></textarea>
                        <br>
                        ...
                        <div class="row ">
                          ...
                          <div class="col-md-4  text-right">
                            <img class="img-fluid rounded" style="max-height: 180px" src="<?php 
                              if($data->foto_tenaga_didik!="") echo base_url("assets/image/tenagadidik/$data->foto_tenaga_didik");
